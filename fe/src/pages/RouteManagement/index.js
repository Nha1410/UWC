...
function RouteManagement() {
    ...
    useEffect(() => {
        fetch("http://localhost:5001/api/location/fetch")
    ...
    function showRoute(item) {
        ...
        console.log(newPathCoordinates);
        ...
        <>
            {showElement &&
                <div className='flex w-full h-full justify-center mt-[50px]'>
                    ...
                    <button onClick={(e) => closeRoute()} className='flex items-top ml-[10px]'>
                        <FontAwesomeIcon
                            icon={icon({ name: 'x' })}
                        />
                    </button>
            ...
            }
            {
                <div className="w-full h-full bg-[#1A202C] pb-[30px]">
                        ...
                        <div className="flex flex-row justify-between">
                            ...
                            <div className="gap-x-[20px] flex flex row mr-[30px]">
                                ...
                                <div className="flex flex-row w-[122px] h-[40px] bg-[#605CFF] border rounded-[8px] text-white justify-center items-center">
                                    ...
                                    <button className="ml-[8px]">Add New</button>
                    ...
                    <div className="pt-[35px] mx-[30px]">
                        ...
                        {data.map(item => (
                            <div className="flex flex-row">
                                ...
                                />
                                <button className="text-white text-[14px] font-light bg-[#364153] rounded-[10px] mt-[10px] ml-[10px] items-center"
                                    onClick={() => showRoute(item)}> show route</button>
                            </div>
                        ))}
                        {/* <TaskRowItem
                            isTask={isTask}
                    ...
                    <div className='flex w-full justify-center mt-[40px] text-white'>
                        <div className="modal flex flex-col  w-[30%] gap-[1.5rem] text-[14px] bg-[#364153] color-white p-4 rounded">
                            <p className="header">Create New Route</p>
