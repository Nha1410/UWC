        ...
        <>
            <div className='flex h-full'>
                <div className="w-[25%] h-full bg-[#1A202C] pl-[30px] pt-[30px]">
                    <div className='bg-[#364153] h-[90%] rounded-[7px]'>
                        ...
                        <div className='pt-[10px] p-[20px]'>
                            ...
                            <div className='px-[20px] bg-[#1A202C] rounded-[7px] h-[50px]'>
                                <input className='text-white text-[12px] bg-transperent' placeholder="Tìm kiếm  người vận chuyển" />
